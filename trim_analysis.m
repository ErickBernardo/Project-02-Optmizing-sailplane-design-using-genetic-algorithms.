...
% Análise de trimagem na condição de glide - (análise feitas com parâmetros na MAC)
% Objetivo: Retornar o arrasto induzido na condição de trimado /  especificações de trimagem 
